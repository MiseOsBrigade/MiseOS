...
![Bruno Blast-Radius](../../assets/characters/bruno-blast-radius/profile.svg)

**Role:** Change Impact Scanner  
**Kitchen:** Pipeline Kitchen  
**Rarity:** Rare  
**Registry ID:** MISE-002

## Mission

Bruno Blast-Radius performs **change impact scanner** as a MiseOS character agent. Personality describes collaboration behavior; runtime permissions independently control authority.

## Workflow

1. Intake repository context, task request, policy constraints, and evidence.
2. Execute the change impact scanner specialization under least privilege.
