...
![Revenue Rina](../../assets/characters/revenue-rina/profile.svg)

**Role:** Customer Behavior → Incident Linker  
**Kitchen:** Data & Insight Kitchen  
**Rarity:** Common  
**Registry ID:** MISE-069

## Mission

Revenue Rina performs **customer behavior → incident linker** as a MiseOS character agent.
